...
Example:
```bash
<skill_dir>/scripts/mart.py list
```
...
Examples:
```bash
<skill_dir>/scripts/mart.py create --id myreview "Scope line"
printf "Scope line\nDetails" | <skill_dir>/scripts/mart.py create --id myreview
```
...
Example:
```bash
<skill_dir>/scripts/mart.py join <review_id> --name alex --role reviewer
```
...
Example:
```bash
<skill_dir>/scripts/mart.py wait --user alex-abcdef12
```
...
Example:
```bash
<skill_dir>/scripts/mart.py threads create --user alex-abcdef12
```
...
Examples:
```bash
<skill_dir>/scripts/mart.py threads comment --user alex-abcdef12 --thread 0 "Note"
printf "Note" | <skill_dir>/scripts/mart.py threads comment --user alex-abcdef12 --thread 0
```
...
Example:
```bash
<skill_dir>/scripts/mart.py threads view --user alex-abcdef12 --thread 0
```
...
Examples:
```bash
<skill_dir>/scripts/mart.py threads resolve --user alex-abcdef12 --thread 0
<skill_dir>/scripts/mart.py threads comment --user alex-abcdef12 --thread 0 --resolve "Fix applied"
```
...
Examples:
```bash
<skill_dir>/scripts/mart.py view --user alex-abcdef12
<skill_dir>/scripts/mart.py view --review abcdef12
```
## Review status
...
Examples:
```bash
<skill_dir>/scripts/mart.py status --user alex-abcdef12
<skill_dir>/scripts/mart.py status --review abcdef12
```
...
Examples:
```bash
<skill_dir>/scripts/mart.py threads list --user alex-abcdef12
<skill_dir>/scripts/mart.py threads list --review abcdef12
```
...
Example:
```bash
<skill_dir>/scripts/mart.py close --user alex-abcdef12
```
...
Examples:
```bash
<skill_dir>/scripts/mart.py -h
<skill_dir>/scripts/mart.py threads -h
<skill_dir>/scripts/mart.py threads comment -h
```
